...
inline const std::array<std::pair<CustomType, std::string>, static_cast<std::size_t>(CustomType::count)> CustomTypeMap =
    {
...
inline std::string const& getCustomTypeName(CustomType type) {
    return CustomTypeMap.at(static_cast<std::size_t>(type)).second;
}
