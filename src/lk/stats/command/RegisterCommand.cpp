#include "lk/stats/Command/RegisterCommand.h"
...
void registerCommand() {
    ...
    cmd.overload<StatsGui>()
        ...
        .execute([&](CommandOrigin const& origin, CommandOutput& output, StatsGui const& param) {
            ...
            // lk::Entry::getInstance().getSelf().getLogger().info("cmd {} {}", player->getRealName(), param.statsType);
