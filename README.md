...
| 清洗盔甲次数       | 玩家使用炼药锅洗去皮革盔甲染色的次数。             | minecraft:clean_armor                     | :x:     |
| 清洗旗帜次数       | 玩家使用炼药锅洗去旗帜上的图案的次数。             | minecraft:clean_banner                    | :x:     |
| 木桶打开次数       | 玩家打开木桶的次数。                               | minecraft:open_barrel                     | :white_check_mark:    |
| 鸣钟次数           | 玩家敲响钟的次数。                                 | minecraft:bell_ring                       | :x:     |
| 吃掉的蛋糕片数     | 玩家吃下的蛋糕片数。                               | minecraft:eat_cake_slice                  | :x:     |
| 炼药锅装水次数     | 玩家使用水桶将炼药锅装满的次数。                   | minecraft:fill_cauldron                   | :x:     |
...
| 与工作台交互次数   | 玩家和工作台交互的次数。                           | minecraft:interact_with_crafting_table    | :x:     |
...
| 音符盒播放次数     | 玩家击打音符盒的次数。                             | minecraft:play_noteblock                  | :x:     |
...
| 潜影盒清洗次数     | 玩家使用炼药锅洗去潜影盒染色的次数。               | minecraft:clean_shulker_box               | :x:     |
...
| 从炼药锅取水次数   | 玩家从炼药锅中装取水、熔岩和细雪的次数。[1]        | minecraft:use_cauldron                    | :x:     |
