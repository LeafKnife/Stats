...
| BLOCK_MINED      | 与玩家开采的方块数相关的统计信息           | minecraft:mined     | [x]    |
...
| ITEM_PICKED_UP   | 与玩家捡起的掉落物品数量有关的统计信息     | minecraft:picked_up | [x]    |
| ITEM_DROPPED     | 与丢弃的物品数量有关的统计信息             | minecraft:dropped   | [x]    |
| ENTITY_KILLED    | 与玩家杀死的实体数量相关的统计信息         | minecraft:killed    | [x]    |
| ENTITY_KILLED_BY | 与玩家被实体杀死相关的统计信息             | minecraft:killed_by | [x]    |
...
| 木桶打开次数       | 玩家打开木桶的次数。                               | minecraft:open_barrel                     | [x]    |
...
| 箱子打开次数       | 玩家打开箱子的次数。                               | minecraft:open_chest                      | [x]    |
...
| 搜查发射器次数     | 玩家和发射器交互的次数。                           | minecraft:inspect_dispenser               | [x]    |
...
| 搜查投掷器次数     | 玩家和投掷器交互的次数。                           | minecraft:inspect_dropper                 | [x]    |
| 末影箱打开次数     | 玩家打开末影箱的次数。                             | minecraft:open_enderchest                 | [x]    |
| 捕鱼数             | 玩家捕到的鱼的总数。                               | minecraft:fish_caught                     | []     |
| 游戏退出次数       | 玩家点击“保存并退回到标题画面”按钮的次数。         | minecraft:leave_game                      | [x]    |
| 搜查漏斗次数       | 玩家和漏斗交互的次数。                             | minecraft:inspect_hopper                  | [x]    |
| 与铁砧交互次数     | 玩家和铁砧交互的次数。                             | minecraft:interact_with_anvil             | [x]    |
| 与信标交互次数     | 玩家和信标交互的次数。                             | minecraft:interact_with_beacon            | [x]    |
| 与高炉交互次数     | 玩家和高炉交互的次数。                             | minecraft:interact_with_blast_furnace     | [x]    |
| 与酿造台交互次数   | 玩家和酿造台交互的次数。                           | minecraft:interact_with_brewingstand      | [x]    |
| 与营火交互次数     | 玩家和营火交互的次数。                             | minecraft:interact_with_campfire          | []     |
| 与制图台交互次数   | 玩家和制图台交互的次数。                           | minecraft:interact_with_cartography_table | [x]    |
| 与工作台交互次数   | 玩家和工作台交互的次数。                           | minecraft:interact_with_crafting_table    | []     |
| 与熔炉交互次数     | 玩家和熔炉交互的次数。                             | minecraft:interact_with_furnace           | [x]    |
| 与砂轮交互次数     | 玩家和砂轮交互的次数。                             | minecraft:interact_with_grindstone        | [x]    |
| 与讲台交互次数     | 玩家和讲台交互的次数。                             | minecraft:interact_with_lectern           | [x]    |
| 与织布机交互次数   | 玩家和织布机交互的次数。                           | minecraft:interact_with_loom              | [x]    |
| 与锻造台交互次数   | 玩家和锻造台交互的次数。                           | minecraft:interact_with_smithing_table    | [x]    |
| 与烟熏炉交互次数   | 玩家和烟熏炉交互的次数。                           | minecraft:interact_with_smoker            | [x]    |
| 与切石机交互次数   | 玩家和切石机交互的次数。                           | minecraft:interact_with_stonecutter       | [x]    |
| 物品掉落           | 玩家掉落物品的数量，因死亡掉落的物品不计算在内。   | minecraft:drop                            | [x]    |
| 物品附魔次数       | 玩家为物品使用附魔台附魔的次数。                   | minecraft:enchant_item                    | []     |
| 跳跃次数           | 玩家进行跳跃的次数。                               | minecraft:jump                            | [x]    |
| 生物击杀数         | 玩家击杀的生物总数。                               | minecraft:mob_kills                       | [x]    |
| 播放唱片数         | 玩家用唱片机播放音乐唱片的次数。                   | minecraft:play_record                     | []     |
| 音符盒播放次数     | 玩家击打音符盒的次数。                             | minecraft:play_noteblock                  | []     |
| 音符盒调音次数     | 玩家和音符盒交互的次数。                           | minecraft:tune_noteblock                  | [x]    |
| 死亡次数           | 玩家死亡的次数。                                   | minecraft:deaths                          | [x]    |
| 盆栽种植数         | 玩家将植物种进花盆的次数。                         | minecraft:pot_flower                      | []     |
| 玩家击杀数         | 玩家（在开启 PvP 的服务器中）击杀的玩家总数        | minecraft:player_kills                    | [x]    |
...
| 潜影盒打开次数     | 玩家打开潜影盒的次数。                             | minecraft:open_shulker_box                | [x]    |
...
| 躺在床上的次数     | 玩家在床上睡觉的次数。                             | minecraft:sleep_in_bed                    | [x]    |
| 村民交易次数       | 玩家和村民进行交易的次数。                         | minecraft:traded_with_villager            | []     |
| 陷阱箱触发次数     | 玩家打开陷阱箱的次数。                             | minecraft:trigger_trapped_chest           | [x]    |
| 从炼药锅取水次数   | 玩家从炼药锅中装取水、熔岩和细雪的次数。[1]        | minecraft:use_cauldron                    | []     |
